...
echo ""
info "📋 配置信息:"
$ENABLE_SS && echo "   SS 端口: $PORT_SS | 密码: ***(已隐藏) | 加密: $SS_METHOD"
$ENABLE_HY2 && echo "   HY2 端口: $PORT_HY2 | 密码: ***(已隐藏)"
$ENABLE_TUIC && echo "   TUIC 端口: $PORT_TUIC | UUID: ***(已隐藏) | 密码: ***(已隐藏)"
$ENABLE_REALITY && echo "   Reality 端口: $PORT_REALITY | UUID: $UUID"
$ENABLE_ANYTLS && echo "   AnyTLS 端口: $PORT_ANYTLS | 用户: $ANYTLS_USER | 密码: ***(已隐藏)"
echo "   服务器: $PUB_IP"
